...
CaratLane provides the exquisite craftsmanship of beautiful jewellery designs such as rings, earrings, pendants, necklace, chains, bangles, bracelets, mangalsutra, nose pins. Apart from jewellery, CaratLane offers 22k (916) and 24k (995) gold coins with certification and the guarantee of a BIS Hallmarked stamp.</p>
     ...
     <div style={{backgroundColor:"rgb(234, 222, 245)",padding:"20px 0px"}}>
      <div style={{display:"flex",justifyContent:"space-evenly",padding:"60px 0px"}}>
        ...
        <div>
          <h4>CONTACT US</h4>
          <div className='contact' style={{display:"flex",justifyContent:"space-evenly",}}>
          <img src="https://cdn-icons-png.flaticon.com/128/831/831309.png" alt=""/>
          <img src="https://cdn-icons-png.flaticon.com/128/3817/3817255.png" alt="" />
          <img src="https://cdn-icons-png.flaticon.com/128/3721/3721843.png" alt="" />
          </div>
         
          <ul style={{fontSize:"12px",marginTop:"10px"}}>
            <li>24X7 Enquiry Support ( ALL Days )</li>
            <li>General : Contactus@Caratlane.Com</li>
            <li>Corporate : B2B@Caratlane.Com</li>
      ...
      <div>
        <div className='logo' style={{display:"flex",justifyContent:"space-evenly",marginLeft:"100px"}}>
          <img src="https://cdn-icons-png.flaticon.com/128/1384/1384063.png" alt="" />
         ...
         <img src="https://cdn-icons-png.flaticon.com/128/3128/3128212.png" alt="" />
        </div>
        <div>
          <h4 style={{marginRight:"1100px"}}>Download our App</h4>
          <div className='app' style={{display:"flex",justifyContent:"space-evenly",width:"100px",marginLeft:"100px"}}>
           <img src="https://cdn-icons-png.flaticon.com/128/3128/3128279.png" alt="" />
          <img src="https://cdn-icons-png.flaticon.com/128/831/831329.png" alt="" />
          </div>
        </div>
      </div>
     </div>
     <div className='popular' style={{padding:"30px"}}>
      <h1>Popular Searches</h1>
     <Link to="/NewArrivals"><p style={{marginRight:"1040px"}}>New Arrivals</p></Link> 
      <p style={{marginRight:"500px"}}>Gold Pendant | Diamond Pendant | Solitaire Pendant | Gemstone Pendant | 22KT Pendants</p>
     <hr style={{color:" rgb(96, 96, 95)"}}/>
    <Link to="/Rings"><p style={{marginRight:"1090px"}}>Rings</p></Link> 
      <p style={{marginRight:"400px"}}>Diamond Rings | Gold Rings | Platinum Rings | Solitaire Rings | Gemstone Rings | Ruby Ring |Mens Rings</p>
     <hr />
    <Link to="/Earings"><p style={{marginRight:"1075px"}}>Earrings</p></Link> 
      <p style={{marginRight:"390px"}}>Gold Earrings |Diamond Earrings | Gemstone Earrings | Solitaire Earrings | Platinum Earrings | 22kt Earrings</p>
     <hr />
     <Link to="/Bangles"><p style={{marginRight:"1000px"}}>Bracltes & Bangles</p></Link> 
      <p style={{marginRight:"660px"}}>Gold Bangles | Diamond Bangles | Gemstone Bangles | 22kt Bangles</p>
     <hr />
    <Link to="/Necklace"><p style={{marginRight:"1065px"}}>Necklace</p></Link> 
      <p style={{marginRight:"510px"}}>Gold Necklace | Diamond Necklace | Kids Necklace | Gemstone Necklace |Ruby Necklace</p>
     <hr />
    <Link to="Kids"><p style={{marginRight:"1100px"}}>Kids</p></Link> 
      <p style={{marginRight:"500px"}}>Gold Pendant | Diamond Pendant | Solitaire Pendant | Gemstone Pendant | 22KT Pendants</p>
     <hr />
    <Link to="/Gifts"><p style={{marginRight:"1100px"}}>Gifts</p></Link> 
      <p style={{marginRight:"680px"}}>Gold | Diamond | Solitaire | Gemstone | 22kt Jewellery | Platinum</p>
     <hr />
     </div>
    </div>
  )
