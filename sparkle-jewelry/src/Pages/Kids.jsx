...
const Kids = () => {
  ...
  const getData=async ()=>{
    const res = await fetch("https://63c6b45e4ebaa802854bc9c2.mockapi.io/jewelry?page=5&limit=20");
  ...
  return (
    ...
    <div>
     ...
     <div>
   <img src="https://banner.caratlane.com/live-images/2f288a36fca243239f60f94730c6b49c.webp" alt="" />
  </div>
    ...
    <div style={{display:"flex"}}>
      ...
      <div>
       <div style={{padding:"60px 40px"}}><img src="https://banner.caratlane.com/live-images/d13e429900af4ee9b82b1755fcccb8c4.webp" alt="" width={1100}/> </div>
       <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"30px",padding:"0px 40px"}}>
      {
        data.map((item)=>(
          <div key={item.id} className="card">
          <Link to={`/Kids/${item.id}`}> <img src={item.avatar} alt="" width={500}/></Link>
          <h1>₹ {item.price}</h1>
          <h3>{item.name}</h3>
